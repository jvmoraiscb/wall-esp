...
page += "<style>";
page += "html{";
page += "background-color: mintcream;";
page += "}";
page += "section{";
page += "display: flex;";
...
page += "<div>";
page += "<p align=center> ";
page += "<button style=background-color:azure;width:9vw;height:8vw onmousedown=getsend('go') onmouseup=getsend('stop') ontouchstart=getsend('go') ontouchend=getsend('stop') ><b>Forward</b></button> ";
page += "";
page += "</p>";
page += "<p align=center>";
...
page += "</p>";
page += "<p align=center>";
page += "<button style=background-color:azure;width:9vw;height:8vw onmousedown=getsend('back') onmouseup=getsend('stop') ontouchstart=getsend('back') ontouchend=getsend('stop') ><b>Backward</b></button>";
page += "</p>";
page += "</div>";
...
page += "</p>";
page += "<p align=center>";
page += "<button style=background-color:ghostwhite;width:9vw;height:8vw onmousedown=getsend('servoYUp')><b>Up</b></button>";
...
page += "<button style=background-color:ghostwhite;width:9vw;height:40px onmousedown=getsend('servoClawClose')><b>Close Claw</b></button>";
page += "</p>";
page += "</div>";
